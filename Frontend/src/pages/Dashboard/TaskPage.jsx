  ...
  return (
    <div style={{ backgroundColor: THEME.bg, minHeight: '100vh', padding: '30px' }}>
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        <div className="flex items-center justify-between py-6 border-t border-b" style={{ borderColor: THEME.border }}>
          ...
          <div className="flex items-center gap-3 bg-white px-4 py-2 rounded-2xl shadow-sm border border-gray-100">
            ...
            <input 
              ...
              className="w-14 text-center font-bold outline-none text-purple-600 bg-gray-50 rounded-lg p-1"
              min="1"
            />
